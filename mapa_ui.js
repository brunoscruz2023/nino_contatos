...
App.Mapa.UI = {
    ...
    getCalloutPath: function(x1, y1, x2, y2) {
    ...
    changeRegionFilter: function(region) {
        ...
        var mobileSelect = document.getElementById('mobile-region-filter');
        ...
        if (viewEventos && !viewEventos.classList.contains('hidden')) {
            if (typeof renderEventosView === 'function') renderEventosView();
        }
    },

    changeFunctionFilter: function(funcao) {
    ...
    changeTeamFilter: function(team) {
        ...
        var mobileSelect = document.getElementById('mobile-team-filter');
        var desktopSelect = document.getElementById('desktop-team-filter');
    ...
    applyFilters: function() {
        ...
        var currentMonthStart = new Date(todayDate.getFullYear(), todayDate.getMonth(), 1);
    ...
    toggleKebabMenu: function() {
        ...
        var overlay = document.getElementById('kebab-overlay');
